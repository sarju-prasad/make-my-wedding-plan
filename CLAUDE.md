...
wedding management platform for Indian weddings. The frontend is a separate
Next.js repository and is not part of this codebase.
...
The four documents in `doc/` define the product and the system:
